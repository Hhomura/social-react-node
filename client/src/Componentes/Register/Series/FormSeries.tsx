                ...
                <>
                    {!updateActive ? (
                        <form className='container_form' onSubmit={submitMethod} encType="multipart/form-data">
                            <InputBackground setRemmove={removeBackground} text='background_series' label='Foto de Fundo' placeholder='' handleOnChange={handleBackground} name='background_series' type='file' />
                            <InputProfile setRemove={removeProfile} text='profile_series' label='Foto da Franquia' placeholder='' handleOnChange={handleProfile} name='profile_series' type='file' />
...
<Input text='Ano' label='Ano' placeholder='Ano' handleOnChange={handleAno} name='ano' type='number' />
                        ...
                        <>
                            <form className='container_form' onSubmit={submitMethod} encType="multipart/form-data">
                                <InputBackground setRemmove={removeBackground} text='background_series' label='Foto de Fundo' placeholder='' handleOnChange={handleBackground} name='background_series' type='file' value={backgroundOfc} />
                                <InputProfile setRemove={removeProfile} text='profile_series' label='Foto da Franquia' placeholder='' handleOnChange={handleProfile} name='profile_series' type='file' value={profileOfc} />
