...
function AuthProvider(prop: props) {
  ...
  const [adm, setAdm] = useState<string | null>(localStorage.getItem('userType'));
  ...
  return (
    <AuthContext.Provider value={{ handleLogin, setAdm, adm, msg, status, setMsg, setStatus, setMsgReg, setStatusReg, setNome, nome, setApelido, apelido, setId, id, setDescricao, descricao, setProfile, profile, setBackground, background}}>
      {prop.children}
